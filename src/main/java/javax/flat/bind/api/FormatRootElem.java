...
public class FormatRootElem {
	 ...
	 * 
	 * @param startRowsIterationLigne
	 *            the valuDebutLigne to set
	 */
	 ...
	 * 
	 * @param numbersRowsIterator
	 *            the valuNumbLigne to set
	 */
	 ...
	 * 
	 * @param valuLongueurChaine
	 *            the valuLongueurChaine to set
	 */
	 ...
	 * 
	 * @param charcatereRepli
	 *            the charcatereRepli to set
	 */
