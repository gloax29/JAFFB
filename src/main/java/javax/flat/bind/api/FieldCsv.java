...
public class FieldCsv {
	 ...
	 */
	public void setPositionnalControlRegex(
			PositionalControlRegex positionnalControlRegex) {
	 ...
	 */
	public void setPositionnalJavaTypeAdapter(
			PositionalJavaTypeAdapter positionnalJavaTypeAdapter) {
