 ...
 *
 */
public class EnteteSimple {
	// offset =  le depart length = la longeur de la chaine
	// longeur total de l	 chaine est 56  
	@PositionalMappingParse(offset = 1, length = 18)
	private String nomFichier ;
	@PositionalMappingParse(offset = 19, length = 12)
	private String description ;
	//il faut convertir en Date au bon format
	@PositionalMappingParse(offset = 31, length = 8)
	@PositionalJavaTypeAdapter(value=DateConvertddMMyyyy.class)
	private Date debutInfo ;
	@PositionalMappingParse(offset = 39, length = 8)
	@PositionalJavaTypeAdapter(value=DateConvertddMMyyyy.class)
	private Date finInfo ;
	@PositionalMappingParse(offset = 47, length = 2)
	private String filer ;
	@PositionalMappingParse(offset = 49, length = 8)
	@PositionalJavaTypeAdapter(value=DateConvertddMMyyyy.class)
