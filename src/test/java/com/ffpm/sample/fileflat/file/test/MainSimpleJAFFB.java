...
public class MainSimpleJAFFB
{
	...
	public static void main(String[] args) throws Exception {
		...
		FileRootForFFPMSimple ffpmSimple = (FileRootForFFPMSimple) unmarshaller.unmarshal(new File("/root/workspace/JAFFB/src/test/resources/TestSimpleFileflat.txt"));
		...
		File fileReecrir = new File("/root/workspace/JAFFB/src/test/resources/TestecrirNormanlFileflat.txt") ;
		...
		/**
		 * ecriture d'un fichier a partir d'un object
		 * en utilisent le desactivation de certain attribut
		 * 
		 */
		
		File fileDesactivat = new File("/root/workspace/JAFFB/src/test/resources/TestecrirDesactivatFileflat.txt") ;
